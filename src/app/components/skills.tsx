...
const stack = {
  ...
  process: () => [
    ...
    },
    {
      ...
      icon: (
        <SiVercel className="w-10 h-10 hover:text-black transition duration-500 ease-in-out transform hover:scale-105" />
      ),
    },
    {
      id: 3,
...
const content = [
  {
    ...
    content: (
      <div className="border border-black/[0.2] dark:border-white/[0.2] flex flex-col items-start  mx-auto p-4 relative h-full">
